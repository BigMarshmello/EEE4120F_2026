...
hold on
title('Computation Time vs Number of Cores for OpenMP Implementation');
...
hold on;
title('Speedup for Computation + Initialisation vs Number of Cores for OpenMP Implementation');
xlabel('Number of Cores (np)');
ylabel('Speedup (S = T_1 / T_p)');
grid on;
...
hold on;
title('Efficiency for Computation + Initialisation vs Number of Cores for OpenMP Implementation');
xlabel('Number of Cores (np)');
